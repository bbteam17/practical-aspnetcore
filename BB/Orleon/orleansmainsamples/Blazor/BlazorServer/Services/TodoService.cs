...
namespace BlazorServer.Services
{
    public class TodoService
    {
        ...
        public Task SetAsync(TodoItem item) => client.GetGrain<ITodoGrain>(item.Key).SetAsync(item);

        public Task DeleteAsync(Guid itemKey) =>  client.GetGrain<ITodoGrain>(itemKey).ClearAsync();
