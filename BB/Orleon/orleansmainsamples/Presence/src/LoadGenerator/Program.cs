        ...
        public static Task Main(string[] args)
        {
            ...
            return new HostBuilder()
                .ConfigureServices(services =>
                {
                    ...
                    services.AddSingleton<IHostedService>(isp => isp.GetService<ClusterClientHostedService>());
                    services.AddSingleton(isp => isp.GetService<ClusterClientHostedService>().Client);
